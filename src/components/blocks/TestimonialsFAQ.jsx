      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((item, idx) => (
              <div 
                key={idx}
                className="bg-white border border-slate-200 p-8 rounded-2xl shadow-xl flex flex-col justify-between relative hover:border-emerald-300 transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <div>
                  ...
                  <p className="text-slate-800 text-sm leading-relaxed font-medium italic relative z-10">
                ...
                <div className="mt-8 pt-6 border-t border-slate-200">
                  ...
                  <span className="inline-block bg-emerald-100 text-emerald-800 text-[10px] font-black px-2.5 py-1 rounded-md mt-2">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-700 text-sm md:text-base mt-2 font-medium">
              {t('faqSubtitle')}
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className={`p-2 rounded-full transition-transform duration-300 ${
                    openFaqIndex === idx ? 'bg-emerald-600 text-white rotate-180' : 'bg-slate-100 text-slate-700'
                  }`}>
                    <ChevronDown size={18} />
                  </div>
                </button>
                ...
                {openFaqIndex === idx && (
                  <div className="px-6 pb-6 pt-2 text-slate-700 text-sm leading-relaxed border-t border-slate-200 bg-slate-50/50 animate-in fade-in duration-200">
          ...
          <div className="mt-12 p-8 bg-white rounded-2xl border border-slate-200 shadow-xl text-center space-y-4">
