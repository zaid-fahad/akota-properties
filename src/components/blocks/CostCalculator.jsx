...
export default function CostCalculator({ onOpenBooking }) {
  ...
  return (
    <section className="py-20 bg-slate-950 text-white relative overflow-hidden" id="calculator">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-10 shadow-2xl">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {SHARES.map((s, idx) => (
                    ...
                    >
                      ...
                      <p className="text-xs opacity-90 mt-1 font-semibold">{s.size}</p>
                    </button>
                  ))}
                </div>
              </div>
            ...
            <div className="lg:col-span-5 bg-slate-950 border border-slate-800 rounded-2xl p-6 space-y-5 shadow-xl">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between items-center pt-3 border-t border-slate-800">
                  <span className="font-black text-white text-base">{t('myTotalCost')}</span>
              ...
              <div className="bg-emerald-950/80 border border-emerald-800 p-4 rounded-xl text-center">
                <p className="text-[11px] font-black text-emerald-300 uppercase tracking-wider">{t('estMonthlyEmi')}</p>
                ...
                <p className="text-[10px] text-slate-300 mt-1 font-semibold">{t('emiSub')}</p>
              </div>

              {/* Action Button */}
              <button
                onClick={onOpenBooking}
                className="w-full bg-emerald-700 hover:bg-emerald-600 text-white font-black py-3.5 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 text-sm active:scale-95"
              >
                {t('btnBookBudget')} <ArrowRight size={16} />
              </button>

              <p className="text-[11px] text-slate-400 text-center flex items-center justify-center gap-1.5 font-semibold">
                <ShieldCheck size={14} className="text-emerald-400" /> {t('safKablaGuarantee')}
              </p>
