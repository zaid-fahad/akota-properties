...
export default function NotFoundPage() {
  return (
    <>
      <SEOHead title="পৃষ্ঠা পাওয়া যায়নি (404) | একতা প্রপার্টিজ" />
      <main className="min-h-screen pt-32 pb-24 bg-slate-950 text-white flex items-center justify-center relative overflow-hidden">
        <div className="container mx-auto px-4 text-center max-w-lg space-y-6">
          ...
          <h1 className="text-6xl font-black text-emerald-400">৪০৪</h1>
          <h2 className="text-2xl font-bold">দুঃখিত! পৃষ্ঠাটি পাওয়া যায়নি</h2>
          ...
          >
            <ArrowLeft size={18} /> মূল পাতায় ফিরে যান
          </Link>
        </div>
      </main>
    </>
